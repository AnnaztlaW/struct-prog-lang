...
def evaluate(ast, environment):
    ...
    if ast["tag"] == "switch":
        ...
        matched = False ## for the fall through
...
def test_evaluate_switch_statement():
    ...
    # single‐case
    equals("x=12345; switch(1){case 1{x=2}}; x", {}, 2)
    # break within case, early
    equals("x=4; switch(1){case 1{break; x=1;} case 2{x=2}}; x", {}, 4)
    # break within case
    equals("x=4; switch(1){case 1{x=1;break;} case 2{x=2;break;}}; x", {}, 1)
    # multiple cases with fall through
    equals("x=99; switch(2){case 1{x=1234} case 2{x=12;} case 3{x=3;}}; x", {}, 3)
    # multiple cases without fall through
    equals("x=99; switch(2){case 1{x=1234; break;} case 2{x=12;break;} case 3{x=3;break;}}; x", {}, 12)
    # variable comparison
    equals("x=123; y=1; switch(y) {case 1{x=2}}; x", {}, 2)
    # only default
    equals("x=5; switch(1){default{x=1234}}; x", {}, 1234)
    # case with default (no fall through)
    equals("x=0; switch(123){case 123{x=3} default{x=4}}; x", {}, 3)
    #return within switch
    equals("function f(){ x=321; switch(234){case 234{return x;} default{return 0}}}; f()", {}, 321)
    # nested switch
    equals("x=0; switch(1){case 1{switch(2){case 2{x=7}}}}; x", {}, 7)
    # expression evaluation
    equals("x=99; switch(1+1){case 1{x=1234;break;} case 2{x=12;break;}}; x", {}, 12)
